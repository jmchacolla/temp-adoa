...
searchDirectoryFiles(getcwd() . '/', 'package-zj-adoa', $argv[1]);

searchDirectoryFiles(getcwd() . '/', 'PackageZjAdoa', dashesToCamelCase($argv[1], true));

searchDirectoryFiles(getcwd() . '/', 'Package Zj Adoa', dashesToCamelCase($argv[1], true, ' '));
