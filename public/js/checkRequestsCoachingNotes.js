...
/***/ "./resources/js/checkRequestsCoachingNotes.js":
/*!****************************************************!*\
  !*** ./resources/js/checkRequestsCoachingNotes.js ***!
  \****************************************************/
...
function getAgencyEnabled(_x) {
  return _getAgencyEnabled.apply(this, arguments);
}
function _getAgencyEnabled() {
  _getAgencyEnabled = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(agency) {
    var agencyEnabled, enabled;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return ProcessMaker.apiClient.get('adoa/get-agency-enabled/' + agency);
        case 2:
          agencyEnabled = _context.sent;
          _context.next = 5;
          return agencyEnabled.data.rows[0][0];
        case 5:
  ...
  $("#listRequests tr").dblclick(function () {
    ...
    if (window.location.pathname == '/adoa/dashboard/requests') {
      if ($(this).find('td').eq(8)[0].innerText == "COMPLETED") {
        ...
        ProcessMaker.apiClient.get('adoa/get-open-task/' + ProcessMaker.user.id + '/' + $(this).find('td').eq(0)[0].innerText).then(function (responseTask) {
          if (responseTask.data.length == 0) {
            ProcessMaker.alert('You do not have permission to open this request.', 'warning', '15');
          } else {
            window.location = $(_this).find('.fa-external-link-square-alt').parent().attr('href');
          }
        });
      }
    } else {
    ...
    if ($(this).find('td').eq(5)[0].innerText == "COMPLETED") {
      ...
      ProcessMaker.apiClient.get('adoa/get-open-task/' + ProcessMaker.user.id + '/' + $(this).find('td').eq(0)[0].innerText).then(function (responseTask) {
        if (responseTask.data.length == 0) {
          ...
          window.location = $(_this2).find('.fa-external-link-square-alt').parent().attr('href');
        }
      });
    }
  });
  if (window.location.pathname == '/profile/edit') {
    ProcessMaker.confirmModal('Caution', '<div class="text-left">Any changes you make in this screen will not be reflected in HRIS.<br>Do not change the email information.<div>', function () {});
    setTimeout(function () {
...
/***/ 2:
/*!**********************************************************!*\
  !*** multi ./resources/js/checkRequestsCoachingNotes.js ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /opt/mypackages/package-zj-adoa/resources/js/checkRequestsCoachingNotes.js */"./resources/js/checkRequestsCoachingNotes.js");
